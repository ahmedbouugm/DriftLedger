 ...
 * This file demonstrates how to integrate Driftledger with a web frontend
 */

// For React/Vue/Angular applications
export class DriftledgerClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new DriftledgerClient(provider, contractAddress);
